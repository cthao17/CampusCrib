...
public class MainListingAdapter extends RecyclerView.Adapter<MainListingAdapter.ListingViewHolder>{
    private List<ListingModel> listingModels;
    private MainListingAdapter.OnFavoriteClickListener onFavoriteClickListener;
    private MainListingAdapter.OnSendMessageClickListener onSendMessageClickListener;

    public MainListingAdapter(List<ListingModel> listingModels, OnFavoriteClickListener onFavoriteClickListener, OnSendMessageClickListener onSendMessageClickListener) {
    ...
    @NonNull
    @Override
    public MainListingAdapter.ListingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.normal_listing_layout,parent,false);
        return new MainListingAdapter.ListingViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MainListingAdapter.ListingViewHolder holder, int position) {
